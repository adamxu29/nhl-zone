...
const tableCols = 'grid grid-cols-[2fr_0.5fr_0.5fr_0.5fr_0.6fr_0.5fr_0.5fr_0.7fr_0.6fr] md:grid-cols-[2.4fr_0.5fr_0.5fr_0.5fr_0.6fr_0.5fr_0.5fr_0.7fr_0.6fr] items-center gap-x-2 px-3 md:px-4'
  ...
  return(
    <div className={`${tableCols} py-1 border-b border-gray-200 text-sm`}>
      <div className='flex items-center gap-2 md:gap-3'>
        ...
        <img className='hidden md:flex w-[35px] h-[35px] md:w-[45px] md:h-[45px] shrink-0 rounded-full' src={`https://assets.nhle.com/mugs/nhl/20262027/${player.teamAbbrevs.split(',').pop()!.trim()}/${player.playerId}.png`} alt={`${player.name} headshot`}/>
        <p className='text-sm md:text-md font-semibold'>{player.name}</p>
        <span className='text-xs text-gray-500'>{player.teamAbbrevs}</span>
      </div>
